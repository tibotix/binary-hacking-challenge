...
public:
    ...
    enum _InterruptType {
         ...
         * These includes the INT n, as well as the INTO, INT1, INT3, and BOUND instructions.
    ...
    constexpr InterruptCategory category() const {
        switch (m_type) {
...
class Exceptions {
public:
    static constexpr Interrupt DE() { return {VEC_DE, InterruptType::FAULT_EXCEPTION, InterruptClass::CONTRIBUTORY}; }
    static constexpr Interrupt DB() { return {VEC_DB, InterruptType::FAULT_EXCEPTION, InterruptClass::BENIGN}; }
    static constexpr Interrupt NMI() { return {VEC_NMI, InterruptType::NON_MASKABLE_INTERRUPT, InterruptClass::BENIGN}; }
    static constexpr Interrupt BP() { return {VEC_BP, InterruptType::TRAP_EXCEPTION, InterruptClass::BENIGN}; }
    static constexpr Interrupt OF() { return {VEC_OF, InterruptType::TRAP_EXCEPTION, InterruptClass::BENIGN}; }
    static constexpr Interrupt BR() { return {VEC_BR, InterruptType::FAULT_EXCEPTION, InterruptClass::BENIGN}; }
    static constexpr Interrupt UD() { return {VEC_UD, InterruptType::FAULT_EXCEPTION, InterruptClass::BENIGN}; }
    static constexpr Interrupt NM() { return {VEC_NM, InterruptType::FAULT_EXCEPTION, InterruptClass::BENIGN}; }
    static constexpr Interrupt DF(ErrorCode error_code = ZERO_ERROR_CODE_NOEXT) { return {VEC_DF, InterruptType::ABORT_EXCEPTION, InterruptClass::BENIGN, error_code}; }
    static constexpr Interrupt TS(ErrorCode error_code) { return {VEC_TS, InterruptType::FAULT_EXCEPTION, InterruptClass::CONTRIBUTORY, error_code}; }
    static constexpr Interrupt NP(ErrorCode error_code) { return {VEC_NP, InterruptType::FAULT_EXCEPTION, InterruptClass::CONTRIBUTORY, error_code}; }
    static constexpr Interrupt SS(ErrorCode error_code) { return {VEC_SS, InterruptType::FAULT_EXCEPTION, InterruptClass::CONTRIBUTORY, error_code}; }
    static constexpr Interrupt GP(ErrorCode error_code) { return {VEC_GP, InterruptType::FAULT_EXCEPTION, InterruptClass::CONTRIBUTORY, error_code}; }
    static constexpr Interrupt PF(ErrorCode error_code = ZERO_ERROR_CODE_NOEXT) { return {VEC_PF, InterruptType::FAULT_EXCEPTION, InterruptClass::PAGE_FAULT, error_code}; }
    static constexpr Interrupt MF() { return {VEC_MF, InterruptType::FAULT_EXCEPTION, InterruptClass::BENIGN}; }
    static constexpr Interrupt AC(ErrorCode error_code = ZERO_ERROR_CODE_NOEXT) { return {VEC_AC, InterruptType::FAULT_EXCEPTION, InterruptClass::BENIGN, error_code}; }
    static constexpr Interrupt MC() { return {VEC_MC, InterruptType::ABORT_EXCEPTION, InterruptClass::BENIGN}; }
    static constexpr Interrupt XM() { return {VEC_XM, InterruptType::FAULT_EXCEPTION, InterruptClass::BENIGN}; }
    static constexpr Interrupt VE() { return {VEC_VE, InterruptType::FAULT_EXCEPTION, InterruptClass::PAGE_FAULT}; }
    static constexpr Interrupt CP(ErrorCode error_code = ZERO_ERROR_CODE_NOEXT) { return {VEC_CP, InterruptType::FAULT_EXCEPTION, InterruptClass::CONTRIBUTORY, error_code}; }
